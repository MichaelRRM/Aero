...
{
    protected readonly AutoGenerated.MdhDbContext DbContext;
    
    protected DatedModelSaver(AutoGenerated.MdhDbContext dbContext)
    {
        DbContext = dbContext;
    }
    
    public async Task<SaveResult<TBusinessEntity>> SaveAsync(List<TBusinessEntity> entities, AutoGenerated.MdhDbContext dbContext,
